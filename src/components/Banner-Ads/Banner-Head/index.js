                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Danh sách quảng cáo header</h4>
                                <NavLink to={"/banner-head/create"}  style={{textDecoration:"none"}} className="card-description">
                                        ...
                                        <tbody>
                                            {bannerSlide.map((item, index) => {
                                                return <tr key={index}>
                                                    ...
                                                    <td>
                                                        <NavLink to={"/banner-head/update/" +item.src} ><button type="button" className="btn btn-outline-secondary btn-fw">Sửa</button></NavLink>
