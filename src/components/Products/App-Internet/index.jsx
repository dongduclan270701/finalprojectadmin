...
const Index = () => {
    ...
    const handleOpenSelectToggle = () => {
        Swal.fire({
            ...
            html:(
                '<button id="toggleApp" className="btn btn-primary" style="margin-right:10px"> ' +
                'App' +
                '</button>' +
                '<button id="toggleInternet" className="btn btn-primary" style="margin-left:10px">' +
                'Internet' +
                '</button>'),
            ...
            didOpen: () => {
                ...
                const toggleApp = $('#toggleApp')
                toggleApp.addEventListener('click', () => {
                    navigate("/app/create")
                    Swal.close();
                })
                const toggleInternet = $('#toggleInternet')
                toggleInternet.addEventListener('click', () => {
                    navigate("/internet/create")
                    Swal.close();
                })
            },
        });
                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Danh sách sản phẩm App - Internet</h4>
