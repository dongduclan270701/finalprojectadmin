...
import { fetchCreateAppleCollecting, fetchCollectingByName } from 'Apis'
                        ...
                        axios.post(uploadUrlProduct, formData, {
                            ...
                            .then((response) => {
                                ...
                                if (i === listImage.length - 1) {
                                    //Post axios
                                    fetchCreateAppleCollecting({...updatedProduct, category: updatedProduct.category = updatedProduct.category.filter(category => category !== "")})
                                        .then(result => {
                                            Swal.close()
                                            Swal.fire({
            ...
            <div className="content-wrapper">
                <div className="col-lg-12 grid-margin">
                    <div className="row" style={{ display: "flex", "flexDirection": "row", "alignItems": "center" }}>
                        ...
                        <h3 className="col-lg-10 font-weight-bold" style={{ "marginTop": 15 }}>Add new product details Apple</h3>
                    </div>
                </div>
