...
import { fetchListOfAppleCollectingByName } from 'Apis'
...
const Index = () => {
    ...
    useEffect(() => {
        fetchListOfAppleCollectingByName(params.src)
            .then(result => {
                console.log(result)
                setProduct(result)
            })
            ...
            <div className="content-wrapper">
                <div className="col-lg-12 grid-margin">
                    <div className="row" style={{ display: "flex", "flexDirection": "row", "alignItems": "center" }}>
                        ...
                        <h3 className="col-lg-10 font-weight-bold" style={{ "marginTop": 15 }}>Product details Apple</h3>
                    </div>
                </div>{product ? <>
                    <div className="grid-margin" style={{ display: "flex", "justifyContent": "center" }}>
                        <NavLink className="col-lg-2 btn btn-outline-secondary btn-fw" to={"/apple/update/" + product.src}>Update</NavLink>
                    </div>
