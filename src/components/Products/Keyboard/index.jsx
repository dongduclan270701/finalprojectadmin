                    ...
                    <div className="col-lg-12 grid-margin stretch-card">
                        <div className="card">
                            <div className="card-body">
                                <h4 className="card-title">Danh sách sản phẩm Bàn Phím</h4>

                                <NavLink to={"/keyboard/create"} className="card-description" style={{textDecoration:"none"}}>
                                    ...
                                    <table className="table table-hover">
                                        ...
                                        {product.map((item, index) => {
                                                return <tr key={index}>
                                                    ...
                                                    <td>
                                                        <NavLink to={"/keyboard/" + item.src} ><button type="button" className="btn btn-outline-secondary btn-fw">Xem</button></NavLink>
                                                    </td>
                                                </tr>
                                            })}
                                        </tbody>
