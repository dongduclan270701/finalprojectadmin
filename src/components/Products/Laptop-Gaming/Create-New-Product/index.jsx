...
import { fetchCreateLaptopGamingCollecting, fetchCollectingByName } from 'Apis'
                        ...
                        axios.post(uploadUrlProduct, formData, {
                            ...
                            .then((response) => {
                                ...
                                if (i === listImage.length - 1) {
                                    //Post axios
                                    fetchCreateLaptopGamingCollecting({...updatedProduct, category: updatedProduct.category = updatedProduct.category.filter(category => category !== "")})
                                        .then(result => {
                                            Swal.close()
                                            Swal.fire({
