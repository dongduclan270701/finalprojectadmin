            ...
            <div className="content-wrapper">
                <div className="col-lg-12 grid-margin">
                    <div className="row" style={{ display: "flex", "flexDirection": "row", "alignItems": "center" }}>
                        ...
                        <h3 className="col-lg-10 font-weight-bold" style={{ "marginTop": 15 }}>Thông tin chi tiết sản phẩm Laptop Gaming</h3>
                    </div>
                </div>
                <div className="grid-margin" style={{ display: "flex", "justifyContent": "center" }}>
                    <NavLink className="col-lg-2 btn btn-outline-secondary btn-fw" to={"/laptop-gaming/update/1"}>Chỉnh sửa</NavLink>
                </div>
                        ...
                        <div className="col-md-12" style={{ "padding": 0 }}>
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="form-group">
                                        <label>Storage</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Storage" aria-label="Storage" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>GPU</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="GPU" aria-label="GPU" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Monitor</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Monitor" aria-label="Monitor" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Keyboard</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Keyboard" aria-label="Keyboard" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Audio</label>
                                    ...
                                    <div className="form-group">
                                        <label>LAN</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="LAN" aria-label="LAN" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Wireless</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Wireless" aria-label="Wireless" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Webcam</label>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="form-control form-control-sm" placeholder="Communication" aria-label="Communication" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>System</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="System" aria-label="System" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Battery</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Battery" aria-label="Battery" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Weight</label>
                                    ...
                                    <div className="form-group">
                                        <label>Color</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Color" aria-label="Color" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Security</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Security" aria-label="Security" disabled />
                                    </div>
                                    <div className="form-group">
                                        <label>Size</label>
                                        <input type="text" className="form-control form-control-sm" placeholder="Size" aria-label="Size" disabled />
                                    </div>
                                </div>
                            </div>
                        </div>
