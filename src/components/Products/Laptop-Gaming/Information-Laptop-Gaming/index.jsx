...
import { fetchListOfLaptopGamingCollectingByName } from 'Apis'
...
const Index = () => {
    ...
    useEffect(() => {
        fetchListOfLaptopGamingCollectingByName(params.src)
            .then(result => {
                console.log(result)
                setProduct(result)
            })
            ...
            <div className="content-wrapper">
                <div className="col-lg-12 grid-margin">
                    ...
                    <div className="grid-margin" style={{ display: "flex", "justifyContent": "center" }}>
                        <NavLink className="col-lg-2 btn btn-outline-secondary btn-fw" to={"/laptop-gaming/update/" + product.src}>Update</NavLink>
                    </div>
