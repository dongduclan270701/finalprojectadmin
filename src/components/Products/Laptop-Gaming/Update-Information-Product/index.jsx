                                ...
                                <div className="card-body">
                                    ...
                                    <div className="form-group">
                                        ...
                                        {inputElement.gift.map((item, index) => {
                                            return <input style={{ marginBottom: "15px" }} key={index} type="text" onChange={(e) => setInputElement((inputElement) => ({ ...inputElement, gift: [e.target.value] }))} className="form-control form-control-sm" placeholder="Username" aria-label="Username" />
                                        })}
