...
import ChartRateGoods from 'components/Products/Page-Chart/ChartSoldGoodsInMonth'
                    ...
                    <div className="card" style={{ "marginBottom": "25px" }}>
                        <div className="card-body">
                            <div className='row'>
                                {changeChart ?
                                    <div className="col-lg-12 form-group" style={{ textAlign: "center" }}>
                                        <h4>Chart Sold Goods on Category in Month
                                    ...
                                    :
                                    <div className="col-lg-12 form-group" style={{ textAlign: "center" }}>
                                        <h4>Chart View Goods on Category in Month
                                            <p onClick={handleChangeChart} style={{ textAlign: "end", color: "blue", cursor: "pointer" }}>Sold</p>
                                        </h4>
                                        <ChartViewGoodsOnCategory optionSelectLaptop={optionSelectLaptop} />
                                    </div>
                                }
                            </div>
                        </div>
