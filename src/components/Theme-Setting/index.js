...
const Index = (props) => {
    const {getDataChooseSettingThemePages, chooseSettingThemePages,getIsChooseSettingThemePages} = props
    return (
        <>
            <div className="theme-setting-wrapper">
                <div
                    onClick={() => getIsChooseSettingThemePages(!chooseSettingThemePages)}
                ...
                <div id="theme-settings" className={chooseSettingThemePages ? "settings-panel open" : "settings-panel"}>
                    <i className="settings-close ti-close" onClick={() => getIsChooseSettingThemePages(false)} />
                    ...
                    <div className="color-tiles mx-0 px-4">
                        <div className="tiles success" onClick={() => getDataChooseSettingThemePages("navbar-success")} />
                        <div className="tiles warning" onClick={() => getDataChooseSettingThemePages("navbar-warning")} />
                        <div className="tiles danger" onClick={() => getDataChooseSettingThemePages("navbar-danger")} />
                        <div className="tiles info" onClick={() => getDataChooseSettingThemePages("navbar-info")} />
                        <div className="tiles dark" onClick={() => getDataChooseSettingThemePages("navbar-dark")} />
                        <div className="tiles default" onClick={() => getDataChooseSettingThemePages("")} />
                    </div>
                </div>
            </div>
