...
const Index = () => {
    useEffect(() => {
        am5.ready(function () {
            ...
            let chart = ChartUsersAge.container.children.push(am5percent.PieChart.new(ChartUsersAge, {
                layout: ChartUsersAge.verticalLayout,
                innerRadius: am5.percent(50)
            }))
            let series = chart.series.push(am5percent.PieSeries.new(ChartUsersAge, {
                valueField: "value",
            ...
            let legend = chart.children.push(am5.Legend.new(ChartUsersAge, {
